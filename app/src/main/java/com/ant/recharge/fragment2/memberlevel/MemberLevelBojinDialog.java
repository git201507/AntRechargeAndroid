 ...
 */
public class MemberLevelBojinDialog extends BaseDialog {

    private View cancelTV;
    private TextView understandTV;
    private TextView contentTV;

    public MemberLevelBojinDialog(Context context) {
        super(context);
    }


    public MemberLevelBojinDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected MemberLevelBojinDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected View initView() {
        ...
        String alert = "您的会员等级是铂金，享受投资增益0.5%，推荐人投资0.5%返利待遇。";
        /**
