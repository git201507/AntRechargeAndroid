...
public class MemberLevelDialog extends BaseDialog {
    ...
    public MemberLevelDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected MemberLevelDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected View initView() {
        ...
        String alert = "您的会员等级是黑钻，享受投资增益1%，推荐人投资2%返利待遇。";
        /**
