package com.ant.recharge.fragment2.myshare;
...
public class MyShareActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.text_title)).setText("我的分享");
...
//            webView.loadUrl(Profile.SERVER_ADDRESS + "wx/front/wdzh/financial.jhtml?memberId=" + user.getLoginName());
            webView.loadUrl(Profile.SERVER_ADDRESS + "wx/front/wdzh/appwdfx.jhtml?memberId=" + user.getLoginName());
        } catch (Exception e) {
            e.printStackTrace();
        }
