 ...
 */
public class WebviewYLActivity extends BaseActivity {
...
//        setContentView(R.layout.activity_recharge_webview);
        initView(this, R.layout.activity_fillin_webview);
        ...
        ((TextView)findViewById(R.id.text_title)).setText(R.string.fillin_title);
